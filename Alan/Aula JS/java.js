...
//tem um cliente, se ele tiver 100 pontos, ele é premium, se não ele vai ser do tipo comum

let pontos = 100;
let tipo = pontos > 100? 'Premium' : 'Comum';
//se ele for maior do que 100, ele vai ser premium, se não, comum;
console.log(tipo)
...
//como ele pode aplicar, vai dar false
console.log(candidatoRecusado);

// se trocarmos o maior de idade para false, ele não pode 
//aplicar e dai ele vai dar true



//Comparação não boleana

//FALSY : undefined, null, 0, false, '' = (string vazia),
// e o NaN = (not a number). 
